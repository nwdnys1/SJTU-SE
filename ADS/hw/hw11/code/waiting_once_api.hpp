...
struct waiting_once
{
	...
	void call_once_waiting(init_function f);	  // 朴素版
	void call_once_waiting_plus(init_function f); // 进阶版
	// TODO: implement this
	std::mutex mtx;			  // 互斥锁 保护initialized
	bool initialized = false; // 此实体是否已经初始化
};
